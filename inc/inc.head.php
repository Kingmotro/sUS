...
<link href="<?php echo $Core->GetString("URL"); ?>/css/bootstrap.css" rel="stylesheet" type="text/css" />
<link href="<?php echo $Core->GetString("URL"); ?>/css/styles.css" rel="stylesheet" type="text/css" />
<style type="text/css">
body {
	padding-top: 60px;
	padding-bottom: 40px;
...
<link href="<?php echo $Core->GetString("URL"); ?>/css/bootstrap-responsive.css" rel="stylesheet" type="text/css" />
